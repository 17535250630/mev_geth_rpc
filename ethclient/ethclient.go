...
func (ec *Client) EstimateGasBundle(ctx context.Context, msgs []ethereum.CallMsg) ([]EstimateGasBundleRes, error) {
	var res []EstimateGasBundleRes
	var txs []interface{}
	for _, msg := range msgs {
		txs = append(txs, toCallArg(msg))
	}
	err := ec.c.CallContext(ctx, &res, "eth_estimateGasBundle", txs)
	if err != nil {
		return res, err
	}
	return res, nil
